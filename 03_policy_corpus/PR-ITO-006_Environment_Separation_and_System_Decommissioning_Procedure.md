# PR-ITO-006 — Environment Separation and System Decommissioning Procedure
...
## Purpose
Defines environment segregation and the controlled removal of systems.

## Scope and existing provisions
- Environment definitions, promotion paths and decommissioning steps.
...
- Separation of development, test and production for models and training data, with accelerator sandbox isolation.
- Secure removal on retirement: endpoint deregistration, artefact deletion from serving nodes, accelerator memory clearance, index removal and archival of logs for the retention period.
